...
a9 = np.degrees(np.arctan((np.array(x3) - x3[-1]/2)/distanceDiffuserScreen6))
a10 = np.degrees(np.arctan((np.array(x3) - x3[-1]/2)/distanceDiffuserScreen7))
a11 = np.degrees(np.arctan((np.array(x3) - x3[-1]/2)/distanceDiffuserScreen8))
