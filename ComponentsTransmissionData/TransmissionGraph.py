...
filename2 = "Filter_BA510-550\\Transmission_2_510550.txt"
filename3 = "Filter_BA510-550\\Transmission_3_510550.txt"
filename4 = "Filter_BA510-550\\Transmission_4_510550.txt"
...
Data0, = plt.plot(x1, y1, color='k', label='first')
# Data1, = plt.plot(x2, y2, color='b', label='second')
...
# plt.grid(True)
# plt.legend(handles=[Data0, Data1, Data2, Data3], fontsize=18)
plt.minorticks_on()
fig = plt.gcf()
