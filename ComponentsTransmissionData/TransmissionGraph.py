...
Data0, = plt.plot(x1, y1, color='k', label='Emission filter 510-550')
Data1, = plt.plot(x2, y2, color='g', label='Emission filter 500-590')
Data2, = plt.plot(x3, y3, color='b', label='Excitation filter 480-500')
plt.xlim([450, 650])
plt.ylim([0, 100])
